...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("/Users/huangyaning/IdeaProjects/guns/guns-cinema/src/main/java");//这里写你自己的java目录
        gc.setFileOverride(true);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("haungyaning");
        ...
        strategy.setInclude("brand_dict_t", "area_dict_t", "hall_dict_t", "cinema_t", "field_t", "hall_film_info_t");
